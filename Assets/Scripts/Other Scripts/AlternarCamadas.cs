...
public class AlternarCamadas : MonoBehaviour
{
    ...
    public OVRInput.Button mudarCamadaButton = OVRInput.Button.One; // Botão do controle Oculus para alternar camadas
    ...
    void Update()
    {
        // Use o botão do controle Oculus Quest 2 para a alternância
        if (OVRInput.GetDown(mudarCamadaButton))
        {
