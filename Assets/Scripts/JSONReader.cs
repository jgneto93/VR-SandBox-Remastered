...
public class JSONReader : MonoBehaviour {
    ...
    public Vector3 GetCenterOfMassFromPlayerObject(GameObject playerObject) {
        List<float> positions = GetPersonFromPlayerObject(playerObject, currentFrameIndex).centerOfMass;
        Vector3 position = new(positions[0], positions[2], positions[1]) ;
        return position;
    }
